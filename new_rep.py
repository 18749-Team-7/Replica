...
class Replica():
    ...
    def __init__(self, verbose=True):
        while True:
            try:
                self.replication_change = False
                self.old_count = 0
                self.old_count_lock = threading.Lock()
    ...
    def client_msg_queue_proc(self):
        ...
        print("client process queue has exited")
        self.old_count_lock.acquire()
        self.old_count -= 1
        self.old_count_lock.release()
        return
